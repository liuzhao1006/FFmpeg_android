...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Init(
    ...
    vertices[0].mPosition[0]=-640.0f;//x
    vertices[0].mPosition[1]=-328.0f;//y
    ...
    vertices[1].mPosition[0]=640.0f;//x
    vertices[1].mPosition[1]=-328.0f;//y
    ...
    vertices[2].mPosition[0]=-640.0f;//x
    vertices[2].mPosition[1]=328.0f;//y
    ...
    vertices[3].mPosition[0]=640.0f;//x
    vertices[3].mPosition[1]=328.0f;//y
