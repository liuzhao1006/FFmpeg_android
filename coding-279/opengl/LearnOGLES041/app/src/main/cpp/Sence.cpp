...
void InitYUVTextures(){
    ...
    textureY=CreateTexture2D(YData,1280,720,GL_ALPHA,GL_ALPHA);
    textureU=CreateTexture2D(UData,640,360,GL_ALPHA,GL_ALPHA);
    textureV=CreateTexture2D(VData,640,360,GL_ALPHA,GL_ALPHA);
    delete [] filecontent;
}
