...
GLuint program;
GLint modelMatrixLocation,viewMatrixLocation,projectionMatrixLocation,textureYUVLocation;
GLint attrPositionLocation,attrTexCoordLocation,attrTexCoord1Location;
GLuint textureYUV;
...
void InitYUVTextures(){
    ...
    textureYUV=CreateTexture2D(nullptr,1280,720+360,GL_ALPHA,GL_ALPHA);
    //ffmpeg -> yuv
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Init(
    ...
    textureYUVLocation=glGetUniformLocation(program,"U_TextureYUV");
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Render(
    ...
    glUniform1i(textureYUVLocation,0);
    ...
    glEnableVertexAttribArray(attrTexCoord1Location);
    glVertexAttribPointer(attrTexCoord1Location,4,GL_FLOAT,GL_FALSE,sizeof(Vertice),(void*)(sizeof(float)*8));
