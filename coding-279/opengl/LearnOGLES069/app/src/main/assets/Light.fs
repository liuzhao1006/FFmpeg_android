...
void main(){
    ...
    FragColor0=vec4(ambient_color+diffuse_color+specular_color,1.0);
    FragColor1=vec4(ambient_color+diffuse_color+specular_color,1.0);
    FragColor2=vec4(ambient_color+diffuse_color+specular_color,1.0);
    FragColor3=vec4(ambient_color+diffuse_color+specular_color,1.0);
}