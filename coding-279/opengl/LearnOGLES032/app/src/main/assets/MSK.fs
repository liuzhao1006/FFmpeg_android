...
void main(){
    vec4 color=vec4(0.0);
    float horizontal_size_in_pixel=U_ImageSize.x;
    float vertical_size_in_pixel=U_ImageSize.y;
    float msk_size_in_pixel=4.0;
    float msk_size_in_texcoord_s=msk_size_in_pixel/U_ImageSize.x;
    float msk_size_in_texcoord_t=msk_size_in_pixel/U_ImageSize.y;

    float msk_start_pos_x_in_pixel=0.0;
    float msk_start_pos_y_in_pixel=0.0;
    float msk_end_pos_x_in_pixel=msk_start_pos_x_in_pixel+U_ImageSize.x;
    float msk_end_pos_y_in_pixel=msk_start_pos_y_in_pixel+U_ImageSize.y;
