...
GLuint program;
GLint modelMatrixLocation,viewMatrixLocation,projectionMatrixLocation,textureLocation,texture2Location;
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Init(
    ...
    texture2Location=glGetUniformLocation(program,"U_Texture2");

    texture=CreateTextureFromFile("jason.jpg");
    texture2=CreateTextureFromFile("head.png");
