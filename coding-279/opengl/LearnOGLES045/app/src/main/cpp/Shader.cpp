...
void Shader::BeginDraw(glm::mat4 &m, glm::mat4 &v, glm::mat4 &p) {
    glUseProgram(mProgram);
    glUniformMatrix4fv(mModelMatrixLocation,1,GL_FALSE,glm::value_ptr(m));
    glUniformMatrix4fv(mViewMatrixLocation,1,GL_FALSE,glm::value_ptr(v));
    glUniformMatrix4fv(mProjectionMatrixLocation,1,GL_FALSE,glm::value_ptr(p));
    //set attribute
