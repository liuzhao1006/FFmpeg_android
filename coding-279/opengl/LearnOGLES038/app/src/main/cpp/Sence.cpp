...
GLuint program;
GLint modelMatrixLocation,viewMatrixLocation,projectionMatrixLocation,settingLocation,areaLocation;
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Init(
    ...
    program=CreateStandardProgram("test.vs","MoPi3.fs");
    ...
    settingLocation=glGetUniformLocation(program,"U_Setting");
    areaLocation=glGetUniformLocation(program,"U_MoPiArea");

    texture=CreateTextureFromFile("jason.jpg");
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Render(
    ...
    float setting[]={32.0f,700.0f,465.0f,0.0f};
    glUniform4fv(settingLocation,1,setting);
    float area[]={200.0f,400.0f,0.1f,0.0f};
    glUniform4fv(areaLocation,1,area);
    //set attribute
