...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Init(
    ...
    quad->SetPosition(0,-128.0f*scale,-72.0f*scale,0.0f);
    quad->SetTexcoord(0,0.0f,0.0f,0.0f);
    quad->SetPosition(1,128.0f*scale,-72.0f*scale,0.0f);
    quad->SetTexcoord(1,1.0f,0.0f,0.0f);
    quad->SetPosition(2,-128.0f*scale,72.0f*scale,0.0f);
    quad->SetTexcoord(2,0.0f,1.0f,0.0f);
    quad->SetPosition(3,128.0f*scale,72.0f*scale,0.0f);
