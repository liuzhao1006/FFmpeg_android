...
GLuint program;
GLint modelMatrixLocation,viewMatrixLocation,projectionMatrixLocation,whiteSettingLocation;
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Init(
    ...
    program=CreateStandardProgram("test.vs","HardLight.fs");
    ...
    whiteSettingLocation=glGetUniformLocation(program,"U_WhiteSetting");
...
extern "C" JNIEXPORT void JNICALL Java_cn_battlefire_learnogles_MainActivity_Render(
    ...
    float whitesetting[]={0.25f,1.0f,0.0f,0.0f};
    glUniform4fv(whiteSettingLocation,1,whitesetting);
    //set attribute
